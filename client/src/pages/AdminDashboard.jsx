      ...
      {activeTab === 'overview' && (
        <div className="flex flex-col gap-6 animate-in fade-in duration-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3.5">
            ...
            <div className="bg-[#f5f0ff] dark:bg-purple-950/30 border border-purple-200/90 dark:border-purple-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="w-8 h-8 rounded-full bg-purple-100 dark:bg-purple-900/60 text-purple-600 dark:text-purple-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <Trophy size={16} />
                </div>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-purple-700/80 dark:text-purple-400/80 mt-1.5">
            ...
            <div className="bg-[#edf7ff] dark:bg-sky-950/30 border border-sky-200/90 dark:border-sky-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="w-8 h-8 rounded-full bg-sky-100 dark:bg-sky-900/60 text-sky-600 dark:text-sky-300 flex items-center justify-center shrink-0 shadow-2xs">
              ...
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-sky-700/80 dark:text-sky-400/80 mt-1.5">
            ...
            <div className="bg-[#edfaee] dark:bg-emerald-950/30 border border-emerald-200/90 dark:border-emerald-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] sm:text-[11px] font-extrabold text-emerald-700 dark:text-emerald-300 uppercase tracking-wider">
                  UNGRADED PHOTOS
                </span>
                <div className="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-900/60 text-emerald-600 dark:text-emerald-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <Clock size={16} />
                </div>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-emerald-700/80 dark:text-emerald-400/80 mt-1.5">
            ...
            <div className="bg-[#f0fdfa] dark:bg-teal-950/30 border border-teal-200/90 dark:border-teal-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] sm:text-[11px] font-extrabold text-teal-700 dark:text-teal-300 uppercase tracking-wider">
                  UNGRADED VIDEOS
                </span>
                <div className="w-8 h-8 rounded-full bg-teal-100 dark:bg-teal-900/60 text-teal-600 dark:text-teal-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <Clock size={16} />
                </div>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-teal-700/80 dark:text-teal-400/80 mt-1.5">
                  Assessments remaining
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#fffbeb] dark:bg-amber-950/30 border border-amber-200/90 dark:border-amber-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] sm:text-[11px] font-extrabold text-amber-700 dark:text-amber-300 uppercase tracking-wider">
                  UNPAID PHOTOS
                </span>
                <div className="w-8 h-8 rounded-full bg-amber-100 dark:bg-amber-900/60 text-amber-600 dark:text-amber-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <UserCheck size={16} />
                </div>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-amber-700/80 dark:text-amber-400/80 mt-1.5">
            ...
            <div className="bg-[#fff7ed] dark:bg-orange-950/30 border border-orange-200/90 dark:border-orange-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] sm:text-[11px] font-extrabold text-orange-700 dark:text-orange-300 uppercase tracking-wider">
                  UNPAID VIDEOS
                </span>
                <div className="w-8 h-8 rounded-full bg-orange-100 dark:bg-orange-900/60 text-orange-600 dark:text-orange-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <UserCheck size={16} />
                </div>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-orange-700/80 dark:text-orange-400/80 mt-1.5">
                  Payment pending entries
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#fff1f2] dark:bg-rose-950/30 border border-rose-200/90 dark:border-rose-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] sm:text-[11px] font-extrabold text-rose-700 dark:text-rose-300 uppercase tracking-wider">
                  TOTAL PHOTOGRAPHS
                </span>
                <div className="w-8 h-8 rounded-full bg-rose-100 dark:bg-rose-900/60 text-rose-600 dark:text-rose-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <Image size={16} />
                </div>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-rose-700/80 dark:text-rose-400/80 mt-1.5">
                  Total image entries
                </p>
              </div>
            </div>
            ...
            {/* Card 8: TOTAL VIDEOS */}
            <div className="bg-[#f5f3ff] dark:bg-violet-950/30 border border-violet-200/90 dark:border-violet-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] sm:text-[11px] font-extrabold text-violet-700 dark:text-violet-300 uppercase tracking-wider">
                  TOTAL VIDEOS
                </span>
                <div className="w-8 h-8 rounded-full bg-violet-100 dark:bg-violet-900/60 text-violet-600 dark:text-violet-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <Play size={16} />
                </div>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-violet-700/80 dark:text-violet-400/80 mt-1.5">
                  Total video entries
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#f0fdf4] dark:bg-emerald-950/30 border border-emerald-200/90 dark:border-emerald-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] sm:text-[11px] font-extrabold text-emerald-800 dark:text-emerald-300 uppercase tracking-wider">
                  TOTAL REVENUE
                </span>
                <div className="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-900/60 text-emerald-700 dark:text-emerald-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <IndianRupee size={16} />
                </div>
              </div>
              <div>
            ...
            <div className="bg-[#eef2ff] dark:bg-indigo-950/30 border border-indigo-200/90 dark:border-indigo-800/50 rounded-2xl p-3.5 flex flex-col justify-between gap-3 shadow-2xs hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] sm:text-[11px] font-extrabold text-indigo-800 dark:text-indigo-300 uppercase tracking-wider">
                  NET PROFIT / LOSS
                </span>
                <div className="w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-900/60 text-indigo-700 dark:text-indigo-300 flex items-center justify-center shrink-0 shadow-2xs">
                  <TrendingUp size={16} />
                </div>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-indigo-700/80 dark:text-indigo-400/80 mt-1.5">
