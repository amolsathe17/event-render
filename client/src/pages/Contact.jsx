      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-linear-to-r from-indigo-900 via-purple-950 to-slate-900 rounded-2xl p-4 sm:p-5 text-white shadow-md mb-4 text-left relative overflow-hidden">
          <div className="relative z-10 max-w-3xl">
            ...
            <h1 className="font-display font-black text-2xl sm:text-3xl mt-1.5 text-white">
              Contact & Location
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch text-left">
          ...
          {/* Column 1: Who We Are */}
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col justify-between h-full gap-3">
            <div>
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-slate-800 mt-auto">
              ...
              <div className="flex gap-2.5 text-slate-500 dark:text-slate-400">
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:text-red-500 transition-colors" title="YouTube">
                  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="w-4 h-4 sm:w-5 sm:h-5" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:text-pink-500 transition-colors" title="Instagram">
                  <svg stroke="currentColor" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" className="w-4 h-4 sm:w-5 sm:h-5" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col justify-between h-full gap-3">
            <div className="flex flex-col h-full">
              ...
              <div className="relative w-full h-44 sm:h-48 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-xs grow min-h-[170px]">
                <iframe
                  title="Location Map"
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors self-start mt-auto"
            >
              <MapPin size={15} /> Open in Google Maps <ExternalLink size={14} />
            </a>
          </div>

          {/* Column 3: Support & Inquiries */}
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col justify-between h-full gap-2.5 text-xs sm:text-sm">
            ...
            <div className="flex flex-col gap-0.5">
              <span className="font-extrabold text-slate-900 dark:text-white flex items-center gap-1.5 text-xs sm:text-sm">
                <Mail size={15} className="text-indigo-600 dark:text-indigo-400" /> Email:
              </span>
            ...
            <div className="flex flex-col gap-0.5">
              <span className="font-extrabold text-slate-900 dark:text-white flex items-center gap-1.5 text-xs sm:text-sm">
                <Phone size={15} className="text-indigo-600 dark:text-indigo-400" /> Phone:
              </span>
            ...
            <div className="flex flex-col gap-0.5">
              <span className="font-extrabold text-slate-900 dark:text-white flex items-center gap-1.5 text-xs sm:text-sm">
                <Building2 size={15} className="text-indigo-600 dark:text-indigo-400" /> Address:
              </span>
            ...
            <div className="flex flex-col gap-0.5">
              <span className="font-extrabold text-slate-900 dark:text-white flex items-center gap-1.5 text-xs sm:text-sm">
                <Globe size={15} className="text-indigo-600 dark:text-indigo-400" /> Website:
              </span>
