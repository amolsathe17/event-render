            ...
            {(activeReport === 'overview' || activeReport === 'participants') ? (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5 my-2">
                ...
                <div className="bg-purple-50/80 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800 rounded-2xl p-3.5 sm:p-4 flex flex-col justify-between gap-1.5 shadow-2xs transition-all hover:shadow-md text-left">
                  ...
                  <span className="text-[10px] font-semibold text-purple-700/80 dark:text-purple-300/80">Total events registered</span>
                </div>

                {/* Total Uploads Card */}
                <div className="bg-emerald-50/80 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-3.5 sm:p-4 flex flex-col justify-between gap-1.5 shadow-2xs transition-all hover:shadow-md text-left">
                  ...
                  <span className="text-[10px] font-semibold text-emerald-700/80 dark:text-emerald-300/80">DSLR verified</span>
                </div>
                ...
                <div className="bg-amber-50/80 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-2xl p-3.5 sm:p-4 flex flex-col justify-between gap-1.5 shadow-2xs transition-all hover:shadow-md text-left">
                  ...
                  <span className="text-[10px] font-semibold text-amber-700/80 dark:text-amber-300/80">Successful payments</span>
                </div>
                ...
                <div className="bg-sky-50/80 dark:bg-sky-950/30 border border-sky-200 dark:border-sky-800 rounded-2xl p-3.5 sm:p-4 flex flex-col justify-between gap-1.5 shadow-2xs transition-all hover:shadow-md text-left">
                  ...
                  <span className="text-[10px] font-semibold text-sky-700/80 dark:text-sky-300/80">Participant privileges</span>
                </div>
              </div>
